...
def create_service(bucket_name):
    ...
    credentials = ServiceAccountCredentials.from_json_keyfile_name(google_cloud_setup.dataMap['cloud']['google_cloud']['credentials']['GOOGLE_CLOUD_CREDENTIALS_JSON'], scopes)
